...
var craftingData = [
  {name:"Stasis Device",value: 15600000,
   resources:[
     {name:"Quantum Processor",qty: 1},
     {name:"Cryogenic Chamber",qty: 1},
     {name:"Iridesite",qty: 1}]},
  {name:"Fusion Ignitor",value: 15600000,
   resources:[
     {name:"Quantum Processor",qty: 1},
     {name:"Portable Reactor",qty: 1},
     {name:"Geodesite",qty: 1}]},
  {name:"Quantum Processor",value: 5200000,
   resources:[
     {name:"Circuit Board",qty: 1},
     {name:"Superconductor",qty: 1}]},
  {name:"Portable Reactor",value: 4200000,
   resources:[
     {name:"Liquid Explosive",qty: 1},
     {name:"Fusion Accelerant",qty: 1}]},
  {name:"Cryogenic Chamber",value: 3800000,
   resources:[
     {name:"Living Glass",qty: 1},
     {name:"Cryo-Pump",qty: 1}]},
  {name:"Superconductor",value: 2000000,
   resources:[
     {name:"Semiconductor",qty: 1},
     {name:"Enriched Carbon",qty: 1}]},
  {name:"Cryo-Pump",value: 1500000,
   resources:[
     {name:"Thermic Condensate",qty: 1},
     {name:"Hot Ice",qty: 1}]},
  {name:"Fusion Accelerant",value: 1500000,
   resources:[
     {name:"Organic Catalyst",qty: 1},
     {name:"Nitrogen Salt",qty: 1}]},
  {name:"Circuit Board",value: 916250,
   resources:[
     {name:"Poly Fibre",qty: 1},
     {name:"Heat Capacitor",qty: 1}]},
  {name:"Liquid Explosive",value: 800500,
   resources:[
     {name:"Acid",qty: 1},
     {name:"Unstable Gel",qty: 1}]},
  {name:"Living Glass",value: 566000,
   resources:[
     {name:"Glass",qty: 5},
     {name:"Lubricant",qty: 1}]},
  {name:"Semiconductor",value: 400000,
   resources:[
     {name:"Nitrogen Salt",qty: 1},
     {name:"Thermic Condensate",qty: 1}]},
  {name:"Hot Ice",value: 400000,
   resources:[
     {name:"Enriched Carbon",qty: 1},
     {name:"Nitrogen Salt",qty: 1}]},
  {name:"Organic Catalyst", value: 320000,
   resources:[
     {name:"Thermic Condensate",qty: 1},
     {name:"Enriched Carbon",qty: 1}]},
  {name:"Acid",value: 188000,
   resources:[
     {name:"Mordite",qty: 25},
     {name:"Fungal Mould",qty: 600}]},
  {name:"Heat Capacitor",value: 180000,
   resources:[
     {name:"Solanium",qty: 200},
     {name:"Frost Crystal",qty: 100}]},
  {name:"Grantine",value: 150000,
   resources:[
     {name:"Ionised Cobalt",qty: 50},
     {name:"Dioxite",qty: 50}]},
  {name:"Geodesite",value: 150000,
   resources:[
     {name:"Dirty Bronze",qty: 1},
     {name:"Herox",qty: 1},
     {name:"Lemmium",qty: 1}]},
  {name:"Iridesite",value: 150000,
   resources:[
     {name:"Aronium",qty: 1},
     {name:"Magno-Gold",qty: 1},
     {name:"Grantine",qty: 1}]},
  {name:"Poly Fibre",value: 130000,
   resources:[
     {name:"Cactus Flesh",qty: 100},
     {name:"Star Bulb",qty: 200}]},
  {name:"Lubricant",value: 110000,
   resources:[
     {name:"Faecium",qty: 50},
     {name:"Gamma Root",qty: 400}]},
  {name:"Nitrogen Salt",value: 50000,
   resources:[
     {name:"Condensed Carbon",qty: 50},
     {name:"Radon",qty: 250}]},
  {name:"Enriched Carbon",value: 50000,
   resources:[
     {name:"Condensed Carbon",qty: 50},
     {name:"Radon",qty: 250}]},
  {name:"Thermic Condensate",value: 50000,
   resources:[
     {name:"Condensed Carbon",qty: 50},
     {name:"Sulphurine",qty: 250}]},
  {name:"Unstable Gel",value: 50000,
   resources:[
     {name:"Cactus Flesh",qty: 200}]},
  {name:"Warp Cell",value: 46750,
   resources:[
     {name:"Antimatter Housing",qty: 1},
     {name:"Antimatter",qty: 1}]},
  {name:"Warp Hypercore",value: 46750,
   resources:[
     {name:"Antimatter",qty: 1},
     {name:"Storm Crystal",qty: 1}]},
  {name:"Salt Refractor",value: 30500,
   resources:[
     {name:"Galactic Trade Terminal",qty: 1}]},
  {name:"Lemmium",value: 25000,
   resources:[
     {name:"Uranium",qty: 1},
     {name:"Pure Ferrite",qty: 1}]},
  {name:"Dirty Bronze",value: 25000,
   resources:[
     {name:"Pyrite",qty: 1},
     {name:"Pure Ferrite",qty: 1}]},
  {name:"Magno-Gold",value: 25000,
   resources:[
     {name:"Ionised Cobalt",qty: 50},
     {name:"Phosphorus",qty: 1}]},
  {name:"Aronium",value: 25000,
   resources:[
     {name:"Ionised Cobalt",qty: 50},
     {name:"Paraffinium",qty: 50}]},
  {name:"Herox",value: 25000,
   resources:[
     {name:"Ammonia",qty: 1},
     {name:"Ionised Cobalt",qty: 1}]},
  {name:"Cobalt Mirror",value: 20500,
   resources:[
     {name:"Galactic Trade Terminal",qty: 1}]},
  {name:"Amino Chamber",value: 12300,
   resources:[
     {name:"Metal Plating",qty: 1},
     {name:"Chlorine",qty: 20},
     {name:"Condensed Carbon",qty: 25}]},
  {name:"Antimatter Housing",value: 6500,
   resources:[
     {name:"Oxygen",qty: 30},
     {name:"Ferrite Dust",qty: 50}]},
  {name:"Magnetic Resonator",value: 6150,
   resources:[
     {name:"Magnetised Ferrite",qty: 40},
     {name:"Ionised Cobalt",qty: 40}]},
  {name:"Solar Mirror",value: 6150,
   resources:[
     {name:"Gold",qty: 40},
     {name:"Silver",qty: 30},
  ...
  {name:"Quantum Computer",value: 4200,
   resources:[
     {name:"Microprocessor",qty: 1},
     {name:"Antimatter",qty: 1},
     {name:"Chromatic Metal",qty: 25}]},
  {name:"Hydraulic Wiring",value: 3600,
   resources:[
     {name:"Carbon Nanotubes",qty: 2},
     {name:"Salt",qty: 20},
     {name:"Di-hydrogen",qty: 40}]},
  {name:"AtlasPass v3",value: 2613,
   resources:[
     {name:"Emeril",qty: 200},
     {name:"Microprocessor",qty: 1}]},
  {name:"Microprocessor",value: 2000,
   resources:[
     {name:"Chromatic Metal",qty: 40},
     {name:"Carbon Nanotubes",qty: 1}]},
  {name:"AtlasPass v2",value: 1856,
   resources:[
  ...
  {name:"Ion Battery", value: 200,
   resources:[
     {name:"Ferrite Dust",qty: 20},
     {name:"Cobalt",qty: 10}]},
  {name:"Life Support Gel", value: 200,
   resources:[
     {name:"Di-hydrogen Jelly",qty: 1},
     {name:"Carbon",qty: 20}]}];

let minedAndCultivated = [
  { name: "Ammonia", value: 62 },
  { name: "Cactus Flesh", value: 28 },
  { name: "Cadmium", value: 234 },
  { name: "Carbon", value: 7 },
  { name: "Chlorine", value: 602 },
  { name: "Chromatic Metal",  value: 245 },
  { name: "Cobalt", value: 198 },
  { name: "Condensed Carbon", value: 24 },
  { name: "Copper", value: 110 },
  { name: "Di-hydrogen", value: 34 },
  { name: "Dioxite", value: 62 },
  { name: "Emeril", value: 275 },
  { name: "Faecium", value: 30 },
  { name: "Ferrite Dust", value: 14 },
  { name: "Frost Crystal", value: 12 },
  { name: "Fungal Mould", value: 16 },
  { name: "Gamma Root", value: 16 },
  { name: "Gold", value: 202 },
  { name: "Ionised Cobalt", value: 401 },
  { name: "Magnetised Ferrite", value: 82 },
  { name: "Mordite", value: 40 },
  { name: "Oxygen", value: 34 },
  { name: "Paraffinium", value: 62 },
  { name: "Phosphorus", value: 62 },
  { name: "Pure Ferrite", value: 28 },
  { name: "Pyrite", value: 62 },
  { name: "Radon", value: 20 },
  { name: "Salt", value: 299 },
  { name: "Silver", value: 101 },
  { name: "Solanium", value: 70 },
  { name: "Star Bulb", value: 32 },
  { name: "Storm Crystal", value: 156950 },
  { name: "Sulphurine", value: 20 },
  { name: "Uranium", value: 62 }
];
